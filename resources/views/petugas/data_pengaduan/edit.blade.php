...
<div class="card">
    <div class="card-body">
        ...
        <form action="{{url('dataPengaduan/update',$item->id_pengaduan)}}" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="form-group">
                <label for="">Nama</label>
                <input type="text" class="form-control @error('nama') is-invalid @enderror" value="{{$item->nama}}" name="nama">
                @error('nama')
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <div class="form-check">
                            <input class="form-check-input" type="radio" name="jenis_kelamin" id="jenis_kelamin1" value="L" @if ($item->jenis_kelamin == 'L') checked @endif>
                            <label class="form-check-label" for="jenis_kelamin1">
                                Laki - laki
                            </label>
                          </div>
                          <div class="form-check">
                            <input class="form-check-input" type="radio" name="jenis_kelamin" id="jenis_kelamin2" value="P" @if ($item->jenis_kelamin == 'P') checked @endif>
